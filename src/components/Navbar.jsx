  ...
  return (
    <header className="bg-white border-b border-gray-200">
        ...
        <nav className="flex gap-1">
            ...
            <button className="p-2 underline text-gray-700 hover:text-gray-900 font-semibold flex items-center gap-1"><i class="fa-solid fa-globe"></i><span>MN</span></button>
