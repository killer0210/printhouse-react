        ...
        <div className="max-w-[1200px] mx-auto px-5 py-5">
          <div className="grid grid-cols-6 grid-rows-6  h-[600px]">
            <div className="col-start-1 col-end-4 row-start-1 row-end-6 rounded-tl-3xl rounded-bl-3xl overflow-hidden relative">
              <div
                className="absolute inset-0 rounded-tl-3xl rounded-bl-3xl hero-overlay-glass"
                aria-hidden="true"
              ></div>
              <div className="relative z-10 px-5 py-5 h-full my-auto text-start space-y-6 flex flex-col justify-center">
                ...
                <p>
                  ...
                  хавтас • Дэвтэр • Маягт • Нэрийн хуудас • Албан бланк,дугтуй •
                  Меню • Тасалбар,талон
                </p>
            ...
            <div
              className=" col-start-4 col-end-7 row-start-1 row-end-7 rounded-tr-3xl rounded-bl-3xl rounded-br-3xl hero-overlay-glass"
            ></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-[1200px] mx-auto px-5">
          <div className="flex items-center justify-between w-full mb-6 ">
            ...
            <a href="#" className="text- text-sm font-medium hover:underline">
              Бүгд
            </a>
          </div>
